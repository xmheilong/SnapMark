...
<p align="center">
  <strong>더 쿨하게, 더 화려하게, 더 생동감 있게</strong>
</p>

<p align="center">
  프레젠테이션, 강의, 화면 녹화를 더욱 생생하고 매력적으로 만들어주는 강력한 화면 주석 및 프레젠테이션 도구
</p>
...
<p align="center">
  ...
  <a href="https://github.com/xmheilong/SnapMark/commits">
    <img src="https://img.shields.io/github/commit-activity/m/xmheilong/SnapMark?style=for-the-badge" alt="커밋 활동">
  </a>
...
[Releases](https://github.com/xmheilong/SnapMark/releases) 페이지에서 운영 체제에 맞는 설치 프로그램을 다운로드하세요:
...
- **macOS**:
  - Apple Silicon (M1/M2/M3 등): `SnapMark_x.x.x_aarch64.dmg`
  - Intel 칩: `SnapMark_x.x.x_x64.dmg`
- **Linux**:
  - ARM 칩: `SnapMark_x.x.x_aarch64.deb` / `SnapMark_x.x.x_aarch64.AppImage` / `SnapMark_x.x.x_aarch64.rpm`
  - x64 칩: `SnapMark_x.x.x_amd64.deb` / `SnapMark_x.x.x_amd64.AppImage` / `SnapMark_x.x.x_amd64.rpm`
...
누른 키를 실시간으로 표시하여 강의와 데모를 더 명확하게 합니다.
<video src="https://github.com/user-attachments/assets/2267d2dd-6a1a-493f-ab19-09f0e5e14d53" width="50%"></video>

### 🌍 다국어 지원

중국어(간체/번체), 영어, 일본어, 한국어, 프랑스어, 독일어, 스페인어 등을 지원합니다.

### 🎯 기타 기능

- ✅ **크로스 플랫폼**: Windows, macOS, Linux 지원
- ✅ **투명 창**: 그리기 시 화면 콘텐츠를 가리지 않습니다
- ✅ **단축키**: 사용자 정의 단축키로 빠르게 기능 전환
...
- [Tauri](https://tauri.app/) - 강력한 데스크톱 애플리케이션 프레임워크
- [Excalidraw](https://excalidraw.com/) - 우수한 손그림 스타일 드로잉 도구
- [Mo.js](https://mojs.github.io/) - 유연한 애니메이션 라이브러리
- [Material-UI](https://mui.com/) - React UI 컴포넌트 라이브러리
- [rdev](https://github.com/Narsil/rdev) - Rust 이벤트 리스닝

## 🎁 프로젝트 지원
이 프로젝트가 도움이 되셨다면 ⭐️ Star를 눌러주세요!

[GitHub Sponsors](https://github.com/sponsors/xmheilong)를 통해 개발을 지원할 수도 있습니다.

---

## 📮 연락처

- **웹사이트**: https://github.com/xmheilong
- **BiliBili**: [@xmheilong](https://space.bilibili.com/426988409)
- **GitHub Issues**: [문제 보고](https://github.com/xmheilong/SnapMark/issues)
